...
//         <div className="grid mt-16 min-h-[82vh] w-full lg:h-[54rem] md:h-[34rem] place-items-stretch bg-[url('/public/images/chair-table-dinning-beach-sea-with-blue-sky.jpg')] bg-center bg-contain bg-no-repeat">
